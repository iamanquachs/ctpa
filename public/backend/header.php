...
<body>
    ...
    ?>
    <!-- <div><img class="loaded" src="../../../frontend/img/loaded.gif"></div> -->
    <div class="container-scroller">
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <ul class="nav">
                ...
                <li class="nav-item menu-items">
                    <a class="nav-link" href="../backend/pages/kienthucyduoc/kienthucyduoc.php">
                        <span class="menu-icon">
                ...
                <li class="nav-item menu-items">
                    <a class="nav-link" href="../backend/pages/thongtinyduoc/thongtinyduoc.php">
                        <span class="menu-icon">
                ...
                <li class="nav-item menu-items">
                    <a class="nav-link" href="../backend/pages/hoivien/danhsachhoivien.php">
                        <span class="menu-icon">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="navbar p-0 fixed-top d-flex flex-row">
                <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
                    ...
                    <ul class="navbar-nav navbar-nav-right">
                        <li id="click_dropdown" class="nav-item dropdown">
                            ...
                            <div id="showinfo" class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
            ...
            <script>
                //open đăng xuất
                document.getElementById('click_dropdown').addEventListener('click', show_dropdown)

                function show_dropdown() {
                    var show = document.getElementById('click_dropdown').getElementsByClassName('show')[0];
                    if (show != undefined) {
                        document.getElementById("showinfo").classList.remove("show")
                    } else {
                        document.getElementById("showinfo").classList.add("show")
                    }
                }


                //open chuyên mục
                document.getElementById('show_cm').addEventListener('click', show_dropdown_cm)

                function show_dropdown_cm() {
                    var show = document.getElementById('show_cm').getElementsByClassName('show')[0];
                    if (show != undefined) {
                        console.log(show)
                        document.getElementById("ui-basic").classList.remove("show")
                    } else {
