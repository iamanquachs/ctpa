        ...
        <div class="breadcrumbs_wrapper">
            ...
            <div class="breadcrumbs-container text-center">
                <ul class="breadcrumbs primary-font">
                    ...
                    <li><span style="font-family: 'FontAwesome'; color: #fff">{{$dt->TEN_CHUYENMUC_DT}}</span>
                    </li>
                    @endforeach
                </ul>
            </div>
                        ...
                        <div class="row" style="margin-bottom: 50px">
                                ...
                                <div class="product-thumb">
                                    <div class="product-container item-img">
                                        <div class="product-image-container">
                                            <a class="product-img-link" href="{{URL::to('chi-tiet-diem-tin/'.$chuyenmuc->ID_DT)}}" title=""><img class="w-100" src="{{URL::to('public/upload/'.$chuyenmuc->HINHANH_DT)}}" alt="img" style="height: 20rem; border-radius: 0.5rem">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-7 col-sm-12">
                                <div class="content-right" style="color: black">
                                    <a href="{{URL::to('chi-tiet-diem-tin/'.$chuyenmuc->ID_DT)}}">
                                    ...
                                    <div class="button d-flex align-items-center" style="margin-top: 3rem">
                                        <a class="btn view button-main" href="{{URL::to('chi-tiet-diem-tin/'.$chuyenmuc->ID_DT)}}" style="background-color: rgba(0,0,0,0.02);
