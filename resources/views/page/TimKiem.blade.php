        ...
        <div class="breadcrumbs_wrapper">
            ...
            <div class="breadcrumbs-container text-center">
                <ul class="breadcrumbs primary-font">
                    <li><a href="#"><span style="font-family: 'FontAwesome';">Kết quả tìm kiếm</span></a>
                    </li>
                    </li>
                </ul>
            </div>
                            ...
                            <div class="col-md-7 col-sm-12">
                                <div class="content-right" style="color: black">
                                    ...
                                    <div class="button d-flex align-items-center" style="margin-top: 3rem">
                                        <a class="btn view button-main" href="{{URL::to('chi-tiet-diem-tin/'.$dt->ID_DT)}}" style="background-color: rgba(0,0,0,0.02);
