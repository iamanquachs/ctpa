                ...
                <div class="content-about text-center m-top" style="margin-top:1rem">
                    <div class="row" style="justify-content: center">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 mg-bottom-50" style="padding:5px 0">
                            ...
                            <div class="right-left hidden-xs slow disciver-now" class="dd">
                                <a class="btn button button-main" style="background-color: #1e551e;min-width: 200px;padding:10px 0;" href="{{URL::to('/phap-luat')}}">Thông tin y dược</a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12 mg-bottom-50" style="padding:5px 0">
                            <div class="right-left hidden-xs slow disciver-now" class="dd">
                                <a class="btn button button-main" style="background-color: #1e551e;min-width: 200px;padding:10px 0;" href="{{URL::to('/phap-luat')}}">Kiến thức</a>
                            </div>
                        </div>
                    </div>
                </div>
